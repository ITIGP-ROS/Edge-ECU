...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "model_road_int8"
...
#define AI_NETWORK_IN_1_CHANNEL     (50)
#define AI_NETWORK_IN_1_SIZE        (50)
#define AI_NETWORK_IN_1_SIZE_BYTES  (50)
#define AI_NETWORK_IN_2_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_NETWORK_IN_2_HEIGHT      (50)
#define AI_NETWORK_IN_2_CHANNEL     (6)
#define AI_NETWORK_IN_2_SIZE        (300)
#define AI_NETWORK_IN_2_SIZE_BYTES  (300)
