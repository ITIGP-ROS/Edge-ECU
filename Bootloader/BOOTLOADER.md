...
*Generated from source at commit `30d6ff0`. For the application, see [`../Application/APPLICATION.md`](../Application/APPLICATION.md). For how the two cooperate, see [`../STM32_OVERVIEW.md`](../STM32_OVERVIEW.md).*
